...
logout_url = "http://211.65.106.6:801/eportal/?c=Portal&a=logout&callback=dr1006&login_method=1&user_account=drcom&user_password=123&ac_logout=1&register_mode=1&wlan_user_ip=172.31.212.243&wlan_user_ipv6=&wlan_vlan_id=0&wlan_user_mac=4c32758cf9a5&wlan_ac_ip=&wlan_ac_name=&jsVersion=3.3.2&v=8914"

logout_request = requests.get(logout_url)
